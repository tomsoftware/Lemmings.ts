...
module Lemmings {
    ...
    export class LemmingsSprite {
        ...
        constructor(fr:BinaryReader, colorPalette:ColorPalette) {
            ...
            this.registerAnimation(SpriteTypes.BUILDING,      1, fr, 3, 16, 13, -8, -10, 16); //- brick-laying (r)
            this.registerAnimation(SpriteTypes.BUILDING,     -1, fr, 3, 16, 13, -8, -10, 16); //- brick-laying (l)
            ...
            this.registerAnimation(SpriteTypes.MINEING,       1, fr, 3, 16, 13, -8, -10, 24); //- mining (r)
